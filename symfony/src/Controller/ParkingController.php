...
class ParkingController extends Controller
{
    ...
    {
        return $this->render('parking/index.html.twig', ['parkings' => $parkingRepository->findAll()]);
    }
    ...
    {
        return $this->render('parking/show.html.twig', ['parking' => $parking]);
    }
    ...
    public function edit(Request $request, Parking $parking): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('parking_edit', ['id' => $parking->getId()]);
        }
